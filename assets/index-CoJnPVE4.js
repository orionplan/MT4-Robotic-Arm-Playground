...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Qn,depthTest:!1,depthWrite:!1})}function Vl(){return new ti({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Va(),fragmentShader:`
		...
		`,blending:Qn,depthTest:!1,depthWrite:!1})}function Hl(){return new ti({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Va(),fragmentShader:`
